...
public class ReimbursementPlan {
	...
	public ReimbursementPlan(String remib_id, int remib_amount, String remib_submitted, String remib_resolved,
			String remib_despcription, String reimb_author, String remib_resolver, int remib_statusId,
			int remib_typeId) {
		super();
	...
	public String getRemib_id() {
		return remib_id;
	}

	public void setRemib_id(String remib_id) {
		this.remib_id = remib_id;
	}
	...
	public String getRemib_resolver() {
		return remib_resolver;
	}

	public void setRemib_resolver(String remib_resolver) {
		this.remib_resolver = remib_resolver;
	}
	...
	public String toString() {
		return "ReimbursementPlan [remib_amount=" + remib_amount + ", remib_submitted=" + remib_submitted
				+ ", remib_resolved=" + remib_resolved + ", remib_despcription=" + remib_despcription
				+ ", reimb_author=" + reimb_author + ", remib_resolver=" + remib_resolver + "]";
	}
